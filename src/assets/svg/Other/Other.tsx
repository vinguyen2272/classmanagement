...
export const GenderIcon: React.FC<IconProps> = ({
  color = '#2D3748',
  fill = 'none',
  width = 24,
  height = 24,
...
export const HomeWorkIcon: React.FC<IconProps> = ({
  color = '#2D3748',
  fill = 'none',
  width = 24,
  height = 24,
...
export const OnDemandVideoIcon: React.FC<IconProps> = ({
  color = '#2D3748',
  fill = 'none',
  width = 24,
  height = 24,
...
export const AccountBoxIcon: React.FC<IconProps> = ({
  color = '#2D3748',
  fill = 'none',
  width = 24,
  height = 24,
...
export const ChromeReaderModeIcon: React.FC<IconProps> = ({
  color = '#2D3748',
  fill = 'none',
  width = 24,
  height = 24,
...
export const RoleIcon: React.FC<IconProps> = ({
  color = '#2D3748',
  fill = 'none',
  width = 24,
  height = 24,
...
export const HelpOutlineIcon: React.FC<IconProps> = ({
  color = '#2D3748',
  fill = 'none',
  width = 24,
  height = 24,
...
export const LocalLibraryIcon: React.FC<IconProps> = ({
  color = '#2D3748',
  fill = 'none',
  width = 24,
  height = 24,
