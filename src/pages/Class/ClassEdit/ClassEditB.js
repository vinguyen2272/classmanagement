...
import styles from './ClassEditB.module.css';
...
export default function ClassEditB() {
    ...
    return (_jsxs("div", { className: styles.container, children: [_jsx(Header, {}), _jsxs("div", { className: styles.content, children: [_jsxs("div", { className: styles.time0, children: [_jsxs("div", { className: styles.time1, children: [_jsx(General, {}), _jsx(TimeFrame, { commenceDate: '', completionDate: '' })] }), _jsx("div", { className: styles.time2, children: _jsx(Attendee, { planned: 10, accepted: 9, actual: 9 }) })] }), _jsx(TrainingDetail, { programNameProp: "DevOps Foundation", programDurationProp: "31 days (97 hours)", programModifiedDateProp: "23/07/2022", programModifiedAuthorProp: "Warrior Tran", programIsBtnEditProp: true, syllabusData: syllabusDataNoImage })] })] }));
}
